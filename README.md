...
- Changed the battery monitoring code when building with the ESP32 Feather V2 build flag (default) to use a simple voltage reading as it doesn't have the MAX17048 chip
